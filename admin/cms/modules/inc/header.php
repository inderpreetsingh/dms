...
<head>
  ...
  <title>Driver Management System | Home</title>
  ...
  <link rel="stylesheet" href="<?php echo $adminurl;?>/dist/css/skins/_all-skins.min.css">
  <!-- Morris chart -->
...
<link href="<?php echo $adminurl;?>/dist/css/jquery.bootgrid.css" rel="stylesheet" />
...
<script src="<?php echo $adminurl;?>/dist/js/jquery.bootgrid.min.js"></script>

<!--data table files---->
<!--data table files by maninder---->
<!--data table files by maninder---->
...
<link rel="stylesheet" href="<?php echo $adminurl;?>/dist/css/jquery.modal.min.css" />

<!---------------Excel Type Filterations------------------->
<!--<link href="https://www.jqueryscript.net/css/jquerysctipttop.css" rel="stylesheet" type="text/css">
     Load jQuery 
  <script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>-->
  <!-- Load the plugin bundle. -->
  <script src="<?php echo $adminurl;?>/css/excel-bootstrap-table-filter-bundle.js"></script>
  <!--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha.6/css/bootstrap.min.css" />-->
  <link rel="stylesheet" href="<?php echo $adminurl;?>/css/excel-bootstrap-table-filter-style.css" />
<!---------------Excel Type Filterations- closed------------------>
