...
$domain = "http://localhost/dms/company"; ////// Root of Domain
$baseurl = "http://localhost/dms/company/modules"; ////// Member Panel URL
$adminurl = "http://localhost/dms/company"; ////// Admin Panel URL
$fronturl = "http://localhost/dms";
$companyurl="http://localhost/dms/company"; ////// Admin Panel URL
}
else{
	$domain = "http://techorion.in/dms2/company"; ////// Root of Domain
$baseurl = "http://techorion.in/dms2/company/modules"; ////// Member Panel URL
$adminurl = "http://techorion.in/dms2/company"; ////// Admin Panel URL
$fronturl = "http://techorion.in/dms2"; ////// Admin Panel URL
$companyurl="http://techorion.in/dms2/company"; ////// Admin Panel URL
