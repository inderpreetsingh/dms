...
<a href="<?php echo $domain;?>/dashboard" class="logo">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="<?php echo $domain;?>/dashboard" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
           ...
           <?php /* <a href="<?php echo $domain;?>/dashboard" class="dropdown-toggle" data-toggle="dropdown">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <?php if($ruserDetail['Admin_Pic']!=''){ 
                ...
                echo '<img src="'.$fronturl.'/uploads/admindocs/'.$ruserDetail['Admin_Pic'].'" class="user-image" alt="User Image">';

              } else{ ?>

              <img src="<?php echo $companyurl;?>/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <?php } ?>
                ...
                <p>
                  ...
                  <small>Company Name: <b><?php echo $rsCompInfo['companyName'];?></b> </small>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  ...
                  <a href="<?php echo $companyurl;?>/signout" class="btn btn-default btn-flat">Sign out</a>
