  ...
  <form method="post" id="frm_add" enctype="multipart/">
          ...
          <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="num" name="year" value="<?php echo $rUp['Year'];?>"/>
          ...
          <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="alpha" name="VehMake" value="<?php echo $rUp['VehMake'];?>"/>
...
<div class="form-group">
                    ...
                    <input type="text" class="form-control" id="alpha2" name="color" value="<?php echo $rUp['Color'];?>" />
...
<div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="alpha3" name="onrnm" value="<?php echo $rUp['OwnerName'];?>"/>
