...
//echo "UPDATE permitmodule set permitnumber='".mysql_real_escape_string($_POST['pernNo'])."',permitissuancedate='".$issDate."',permitexpiry='".$exDate."',permitissuancestate='".$_POST['issuestate']."',issuedby='".mysql_real_escape_string($_POST['issueby'])."',permDesp='".mysql_real_escape_string($_POST['perdesp'])."',isPublished='".$_POST['pub']."',curdate=now(),isDeleted='0' where p_id='".$_POST['pid']."'";
	...
	$sqlQuery=mysql_query("UPDATE permitmodule set 
		companyID='".$_SESSION['companyID']."',
		permitnumber='".mysql_real_escape_string($_POST['pernNo'])."',permitissuancedate='".$issDate."',permitexpiry='".$exDate."',permitissuancestate='".$_POST['issuestate']."',issuedby='".mysql_real_escape_string($_POST['issueby'])."',permDesp='".mysql_real_escape_string($_POST['perdesp'])."',isPublished='".$_POST['pub']."',curdate=now(),isDeleted='0' where p_id='".$_POST['pid']."'");
	if($sqlQuery){
