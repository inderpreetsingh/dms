  ...
  <form method="post" id="frm_add" enctype="multipart/">
				<input type="hidden" value="add" name="action" id="action">
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="issuedate" name="tickdt"/>
                  </div>
                  <div class="form-group">
          ...
          <?php
            ...
            while($rs=mysql_fetch_assoc($allDriver)){
              ...
              echo '<option value="'.$rs['DriverId'].'">'.ucwords($rs['DriverFName'])."&nbsp; ".ucwords($rs['DriverLName']).'</option>';
            }
          ...
          <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="issueby" name="tractorunit"/>
          </div>
          <div class="form-group">
                    <label for="salary" class="control-label">Trailer Unit:</label>
                    <input type="text" class="form-control" id="issueby" name="trailerunit"/>
          </div>
...
<div class="form-group">
                    ...
                    <input type="text" class="form-control" id="fineamt" name="fineamt"/>
          </div>
          ...
          <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="curstatus" name="curstatus"/>
                  </div>
           <div class="form-group">
...
window.location.href="<?php echo $domain;?>/dashboard/ticketsviolators";
    ...
    $("#btn_add").click(function (event) {
        ...
        $.ajax({
            ...
            url: "<?php echo $domain; ?>/modules/inc/add_ticket.php",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
